...
export default class Base64Image extends React.Component<IBase64ImageProps, IBase64ImageState> {
    ...
    public render(): React.ReactElement<IBase64ImageProps> {
        ...
        return (
            <div className={cssClasses('base64ImageEncoder-container')}>
                ...
                {!this.state.showNoImageUploadedContainer &&
                    <div className={cssClasses('base64ImageEncoder-image--preview')} style={imagePreviewStyle}>
                        &nbsp;
                    </div>
                }
                <div className={cssClasses('base64ImageEncoder-buttons')}>
                    ...
                    <IconButton
                        ...
                        onClick={(ev: any): void => {
                            ...
                            const containerElement: HTMLElement = ev.target.closest(`.base64ImageEncoder-container`);
