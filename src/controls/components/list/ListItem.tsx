...
export const ListItem: React.FunctionComponent<IListItemProps> = (props: IListItemProps) => {
    ...
    additionalCssClasses["list-item--clickable"] = mergedProps.clickable;
    additionalCssClasses["list-item--hoverable"] = mergedProps.hoverEffect;
    // additionalCssClasses[styles["list--separator"]] = props.separator;

    return <div {...mergedProps}
        className={cssClasses("list-item", additionalCssClasses, mergedProps.className)}
    ...
    >
        {mergedProps.hoverEffect &&
            <div className={cssClasses("hoverhelper")} tabIndex={-1}></div>
        }
