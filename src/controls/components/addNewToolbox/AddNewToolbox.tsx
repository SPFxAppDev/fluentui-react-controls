...
export class AddNewToolbox extends React.Component<IAddNewToolboxProps, IAddNewToolboxState> {
    ...
    private addNewButtonRef?: HTMLButtonElement;

    public state: IAddNewToolboxState = {
        showAddNewCallout: false
    };

    public constructor(props: IAddNewToolboxProps) {
        super(props);
        initializeIcons();
    }

    public render(): React.ReactElement<IAddNewToolboxProps> {
        const callOutVisbileClass: string = "active-toolbar";
        const isToolboxSeparatorVisibleClass: Record<string, boolean> = {};
        ...
        return (
            <div className={cssClasses("toolbox-container", isToolboxSeparatorVisibleClass)}>
                <button type="button"
                    aria-haspopup="true"
