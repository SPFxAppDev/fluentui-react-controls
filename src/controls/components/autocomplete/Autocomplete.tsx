...
> {
  ...
  public render(): React.ReactElement<IAutocompleteProps> {
    ...
    return (
      <div className={cssClasses("autocomplete-container", this.props.containerClassName)} id={this.autocompleteId}>
        <TextField
  ...
  private renderSuggesstionsFlyout(): JSX.Element {
    ...
    return (
      <div className={cssClasses("autocomplete-flyout", this.props.flyoutClassName)} tabIndex={0}>
